                        ...
                        (t, i) => {
                            ...
                            if (n) {
                                if (((t.innerHTML = ""), (t.title = n.title ?? ""), (t.className = `vapi-btn vapi-btn-is-${i}`), "connect" === n.type)) {
                                    ...
                                    (p.src =
                                        "https://media-hosting.imagekit.io/c91a2fdda68546c5/Logan%20(2)%20(1).gif?Expires=1840435196&Key-Pair-Id=K2ZIVPTIP2VGHC&Signature=XjFYS7oxx6KaHmEAterfOCFDQ~MIrRmkEy3-BxxPN3~LhilBbfrZxbALmiOFOk5viEx9Ma5sykorCs9vUvWvurOICcmmkIYf0qRi1yiloKwr-x7phRXiijyi34Nijl9hJWQgxdKez0SFX6JYeuD6j86X1qAkhzN-ZrUwne~bH5nSfM2Ftk2TTqWY--NUHgmQcUq4wYF2byUmrLvgbocTe08oebFqIZWZIgM9PK3Mk43NX8zxDqg7CrRFXbb~6x6a27w~4AqNH0RRcBE7dBVK9xa81~OSuvp57efOn6IrntPVO2NvNcKWmQ2sRG7bJ~jYL92JF5KOGpOmcAgu~tbdgg__"),
                                        (p.alt = "Agent GIF"),
